...
* [Python code to communicate with Arduino](W25_HealthTech_Innovation_Challenge_Guides/Dashboard/Python_Code/ArduinoToPython.py), to be used with an Arduino running the code above
